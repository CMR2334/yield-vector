# HANDOFF Archive — Yield Vector

Older rounds moved out of [HANDOFF.md](HANDOFF.md) to keep the live log
readable (newest archived round first). For the active log + entry template
see HANDOFF.md; for release-level milestones see [CHANGELOG.md](CHANGELOG.md).

---

## Log (archived — newest first)
